...
public class AlgoRankCrud {
  ...
  public List<Map<String,String>> getRanks(int id) throws SQLException
  {
    HashMap<String, String> hm = new HashMap<String, String>();
    ResultSet rs = MySql.getDbCon().query("Select * from factranks WHERE algoId="+id);
