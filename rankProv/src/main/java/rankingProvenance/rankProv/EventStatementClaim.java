...
public class EventStatementClaim {
  ...
  public List<Map<String,String>> getEventStatment(int stmtId) throws SQLException
  {
    HashMap<String, String> hm = new HashMap<String, String>();
    ResultSet rs = MySql.getDbCon().query("Select * from eventstatementclaim WHERE statementId="+stmtId);
