...
public class References {
  ...
  public List<Map<String,String>> getReference(String url) throws SQLException
  {
    HashMap<String, String> hm = new HashMap<String, String>();
    ResultSet rs = MySql.getDbCon().query("Select claimId from `references` WHERE url LIKE '"+url+"'");
